...
2. [Варианты архитектур ЭВМ: принстонская и гарвардская. Их роли в современных ЭВМ](#2)  
3. [Варианты структур ЭВМ: иерархическая и магистральная](#3)  
4. [Классификация архитектур многопроцессорных вычислительных систем по Флинну](#4)  
5. [Многоуровневая модель функционирования ЭВМ](#5)  
6. [Функциональная структура микропроцессора](#6)  
7. [Краткая характеристика основных узлов](#7)  
8. [Операционные и управляющие автоматы](#8)  
9. [Синтез операционных автоматов канонической структуры](#9)  
10. [Представление чисел в ЭВМ](#10)  
11. [Алгоритмы умножения и деления, структура АЛУ умножения и деления](#11)  
12. [Управляющие автоматы с жёсткой логикой: классификация, основные особенности](#12)  
13. [Управляющие автоматы, построенные по схеме Мура, схеме Мили](#13)  
14. [Управляющие автоматы с хранимой в памяти логикой: принципы построения](#14)  
15. [Микропрограммирование, кодирование микрокоманд](#15)  
16. [Машинная арифметика](#16)  
17. [Выбор оптимального алгоритма умножения и структуры устройства умножения](#17)  
18. [Подходы к ускорению умножения](#18)  
19. [Алгоритмы с восстановлением и без восстановления остатка](#19)  
20. [Простейшая микроархитектура процессора](#20)  
21. [Преимущества трёхшинной микроархитектуры](#21)  
22. [Предвыборка команд: принципы построения, алгоритм функционирования](#22)  
23. [Микроархитектура с предвыборкой команд](#23)  
24. [Простейшая конвейерная микроархитектура](#24)  
25. [Стадии простейшего 5-ти ступенчатого конвейера](#25)  
26. [Принцип суперскалярности](#26)  
27. [Разновидности конфликтов при конвейерном исполнении команд и пути их преодоления](#27)  
28. [Динамическое прогнозирование ветвлений](#28)  
29. [Переименование регистров](#29)  
30. [Внеочередное и спекулятивное выполнение команд](#30)  
31. [Понятие об архитектуре набора команд процессора](#31)  
32. [Архитектура CISC: принципы построения, преимущества, недостатки, признаки](#32)  
33. [Архитектура RISC: принципы построения, преимущества, недостатки, признаки](#33)  
34. [Архитектура VLIW: принципы построения, преимущества, недостатки](#34)  
35. [Группы команд: классификация и основные характеристики](#35)  
36. [Форматы команд: назначение полей](#36)  
37. [Режимы адресации: классификация и основные характеристики](#37)  
38. [Направления повышения производительности вычислений на уровне архитектуры системы команд: SIMD-расширения](#38)  
39. [Статические БИС ЗУ: принципы построения, основные особенности и области применения](#39)  
40. [Динамические БИС ЗУ: принципы построения, основные особенности и области применения](#40)  
41. [Повышение производительности устройств асинхронной динамической памяти](#41)  
42. [Повышение производительности устройств синхронной динамической памяти](#42)  
43. [Расслоение памяти](#43)  
44. [Принципы построения кэш-памяти с прямым отображением](#44)  
45. [Принципы построения полностью ассоциативной кэш-памяти](#45)  
46. [Принципы построения частично ассоциативной кэш-памяти](#46)  
47. [Проблема замещения: физически нереализуемые и реализуемые алгоритмы](#47)  
48. [Проблема обеспечения целостности данных: алгоритмы сквозной, буферизованной сквозной и обратной записи](#48)  
49. [Модели многоуровневой кэш-памяти](#49)  
50. [Сегментная организация памяти в защищенном режиме: принципы построения, дескрипторы и дескрипторные таблицы](#50)  
51. [Сегментная организация памяти в защищенном режиме: принципы построения, схема получения линейного адреса](#51)  
52. [Защита памяти на уровне сегментов](#52)  
53. [Страничная организация памяти: назначение, принципы построения, схема получения физического адреса](#53)  
54. [Защита памяти на уровне страниц](#54)  
55. [Управление задачами](#55)  
56. [Прерывания и исключения: источники, порядок обработки](#56)  
57. [Организация таблицы прерываний в реальном и защищённом режимах работы процессора](#57)  
58. [Стратегии замещения страниц в памяти](#58)  

---

## Ответы на вопросы

### 1. Каноническая функциональная структура ЭВМ Джона фон Неймана, архитектурные принципы <a name="1"></a>
...
### 2. Варианты архитектур ЭВМ: принстонская и гарвардская. Их роли в современных ЭВМ <a name="2"></a>
...
### 3. Варианты структур ЭВМ: иерархическая и магистральная <a name="3"></a>
...
### 4. Классификация архитектур многопроцессорных вычислительных систем по Флинну <a name="4"></a>
...
### 5. Многоуровневая модель функционирования ЭВМ <a name="5"></a>
...
### 6. Функциональная структура микропроцессора <a name="6"></a>
...
### 7. Краткая характеристика основных узлов <a name="7"></a>
...
### 8. Операционные и управляющие автоматы <a name="8"></a>
...
### 9. Синтез операционных автоматов канонической структуры <a name="9"></a>
...
### 10. Представление чисел в ЭВМ <a name="10"></a>
...
### 11. Алгоритмы умножения и деления, структура АЛУ умножения и деления <a name="11"></a>
...
### 12. Управляющие автоматы с жёсткой логикой: классификация, основные особенности <a name="12"></a>
...
### 13. Управляющие автоматы, построенные по схеме Мура, схеме Мили <a name="13"></a>
...
### 14. Управляющие автоматы с хранимой в памяти логикой: принципы построения <a name="14"></a>
...
### 15. Микропрограммирование, кодирование микрокоманд <a name="15"></a>
...
### 16. Машинная арифметика <a name="16"></a>
...
### 17. Выбор оптимального алгоритма умножения и структуры устройства умножения <a name="17"></a>
...
### 18. Подходы к ускорению умножения <a name="18"></a>
...
### 19. Алгоритмы с восстановлением и без восстановления остатка <a name="19"></a>
...
### 20. Простейшая микроархитектура процессора <a name="20"></a>
...
### 21. Преимущества трёхшинной микроархитектуры <a name="21"></a>
...
### 22. Предвыборка команд: принципы построения, алгоритм функционирования <a name="22"></a>
...
### 23. Микроархитектура с предвыборкой команд <a name="23"></a>
...
### 24. Простейшая конвейерная микроархитектура <a name="24"></a>
...
### 25. Стадии простейшего 5-ти ступенчатого конвейера <a name="25"></a>
...
### 26. Принцип суперскалярности <a name="26"></a>
...
### 27. Разновидности конфликтов при конвейерном исполнении команд и пути их преодоления <a name="27"></a>
...
### 28. Динамическое прогнозирование ветвлений <a name="28"></a>
...
### 29. Переименование регистров <a name="29"></a>
...
### 30. Внеочередное и спекулятивное выполнение команд <a name="30"></a>
...
### 31. Понятие об архитектуре набора команд процессора <a name="31"></a>
...
### 32. Архитектура CISC: принципы построения, преимущества, недостатки, признаки <a name="32"></a>
...
### 33. Архитектура RISC: принципы построения, преимущества, недостатки, признаки <a name="33"></a>
...
### 34. Архитектура VLIW: принципы построения, преимущества, недостатки <a name="34"></a>
...
### 35. Группы команд: классификация и основные характеристики <a name="35"></a>
...
### 36. Форматы команд: назначение полей <a name="36"></a>
...
### 37. Режимы адресации: классификация и основные характеристики <a name="37"></a>
...
### 38. Направления повышения производительности вычислений на уровне архитектуры системы команд: SIMD-расширения <a name="38"></a>
...
### 39. Статические БИС ЗУ: принципы построения, основные особенности и области применения <a name="39"></a>
...
### 40. Динамические БИС ЗУ: принципы построения, основные особенности и области применения <a name="40"></a>
...
### 41. Повышение производительности устройств асинхронной динамической памяти <a name="41"></a>
...
### 42. Повышение производительности устройств синхронной динамической памяти <a name="42"></a>
...
### 43. Расслоение памяти <a name="43"></a>
...
### 44. Принципы построения кэш-памяти с прямым отображением <a name="44"></a>
...
### 45. Принципы построения полностью ассоциативной кэш-памяти <a name="45"></a>
...
### 46. Принципы построения частично ассоциативной кэш-памяти <a name="46"></a>
...
### 47. Проблема замещения: физически нереализуемые и реализуемые алгоритмы <a name="47"></a>
...
### 48. Проблема обеспечения целостности данных: алгоритмы сквозной, буферизованной сквозной и обратной записи <a name="48"></a>
...
### 49. Модели многоуровневой кэш-памяти <a name="49"></a>
...
### 50. Сегментная организация памяти в защищенном режиме: принципы построения, дескрипторы и дескрипторные таблицы <a name="50"></a>
...
### 51. Сегментная организация памяти в защищенном режиме: принципы построения, схема получения линейного адреса <a name="51"></a>
...
### 52. Защита памяти на уровне сегментов <a name="52"></a>
...
### 53. Страничная организация памяти: назначение, принципы построения, схема получения физического адреса <a name="53"></a>
...
### 54. Защита памяти на уровне страниц <a name="54"></a>
...
### 55. Управление задачами <a name="55"></a>
...
### 56. Прерывания и исключения: источники, порядок обработки <a name="56"></a>
...
### 57. Организация таблицы прерываний в реальном и защищённом режимах работы процессора <a name="57"></a>
...
### 58. Стратегии замещения страниц в памяти <a name="58"></a>
